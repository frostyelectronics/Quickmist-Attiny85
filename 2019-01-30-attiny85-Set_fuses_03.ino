...
/*Instructions:
 * Connect programmer circuit to Arduino Uno on Pin 8,9,10,11,12,13,GND
 * Comment/Uncomment #define HFUSE to desired value
 * Tools: Set board Arduino Uno
 * Set COM port
 * Open Serial Monitor with 9600
 * Upload this sketch to Arduino Uno
 * Press a key to program
 * Wait for confirmation fuses
 *
 */



//#define  HFUSE  0xDF   // Defaults for ATtiny25/45/85 PIN1 = SET AS RESET
#define  HFUSE  0x5F     //                             PIN1 = SET AS IO
#define  LFUSE  0x62   
